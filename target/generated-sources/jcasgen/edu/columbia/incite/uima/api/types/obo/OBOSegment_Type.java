 ...
 * @generated */
public class OBOSegment_Type extends OBOSpan_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (OBOSegment_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = OBOSegment_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new OBOSegment(addr, OBOSegment_Type.this);
  			   OBOSegment_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new OBOSegment(addr, OBOSegment_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = OBOSegment.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.columbia.incite.uima.api.types.obo.OBOSegment");
  ...
  public String getOboType(int addr) {
      ...
      jcas.throwFeatMissing("oboType", "edu.columbia.incite.uima.api.types.obo.OBOSegment");
  ...
  public String getXpath(int addr) {
      ...
      jcas.throwFeatMissing("xpath", "edu.columbia.incite.uima.api.types.obo.OBOSegment");
  ...
  public String getDate(int addr) {
      ...
      jcas.throwFeatMissing("date", "edu.columbia.incite.uima.api.types.obo.OBOSegment");
  ...
  public String getYear(int addr) {
      ...
      jcas.throwFeatMissing("year", "edu.columbia.incite.uima.api.types.obo.OBOSegment");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public OBOSegment_Type(JCas jcas, Type casType) {
    super(jcas, casType);
