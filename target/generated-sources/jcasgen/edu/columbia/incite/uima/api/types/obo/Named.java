 ...
 * @generated */
public class Named extends OBOEntity {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Named.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Named() {/* intentionally empty block */}
   ...
   */
  public Named(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Named(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
